...
/*
|--------------------------------------------------------------------------
| BuildVault Laravel 12 API Routes — Sprint 02
|--------------------------------------------------------------------------
|
| Registers the complete secure standalone API routes for BuildVault.
| Encapsulated under the standard Sanctum authorization token middleware.
|
*/
