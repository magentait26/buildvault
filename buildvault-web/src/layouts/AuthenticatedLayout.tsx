...
export default function AuthenticatedLayout() {
  ...
  const getRoleDisplayName = (r: string) => {
    if (r === 'Super Admin') return 'Admin';
    if (r === 'Legal Team') return 'Legal Officer';
    if (r === 'Finance Team') return 'Finance Officer';
    if (r === 'Auditor') return 'Viewer';
    return r;
  };
          ...
          <div className="flex items-center gap-3">
            ...
            <div id="persona-swapper" className="flex items-center gap-2.5 bg-slate-50 dark:bg-[#051a17] border border-slate-200 dark:border-emerald-950/60 rounded-lg px-2.5 py-1 sm:py-1.5 shadow-3xs">
              ...
              <div className="hidden sm:flex flex-col text-left">
                ...
                <span className="text-[9px] font-bold text-slate-400 dark:text-emerald-450 mt-0.5 uppercase tracking-wide truncate max-w-[100px]">{getRoleDisplayName(selectedRole || '')}</span>
              </div>
              ...
              >
                <option value="Super Admin" className="dark:bg-[#092622] text-slate-800 dark:text-slate-200">Admin</option>
                ...
                <option value="Legal Team" className="dark:bg-[#092622] text-slate-800 dark:text-slate-200">Legal Officer</option>
                <option value="Compliance Officer" className="dark:bg-[#092622] text-slate-800 dark:text-slate-200">Compliance Officer</option>
                <option value="Finance Team" className="dark:bg-[#092622] text-slate-800 dark:text-slate-200">Finance Officer</option>
                <option value="Auditor" className="dark:bg-[#092622] text-slate-800 dark:text-slate-200">Viewer</option>
              </select>
            </div>
            ...
            <div className="mt-auto border-t border-[#1c4d44] pt-4 flex items-center gap-3 w-full bg-[#113f37] select-none">
              ...
              <div className="flex flex-col text-left min-w-0 font-sans">
                ...
                <span className="text-[10px] font-medium text-emerald-305 uppercase leading-none mt-1">
                  {getRoleDisplayName(selectedRole || 'Director')}
                </span>
              </div>
            </div>
          )}
